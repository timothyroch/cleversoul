...
const Question22: React.FC<QuestionProps> = ({ onNext }) => {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>Ai-je bien dormi hier soir ?</h3>
        <textarea
          value={response}
          onChange={(e) => setResponse(e.target.value)}
          placeholder="Décrivez la qualité de votre sommeil hier soir."
