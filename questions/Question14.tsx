...
const Question14: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>
          Ai-je ressenti un lien avec quelque chose de plus grand que moi (la nature, la spiritualité, l’univers) ?
        </h3>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez votre sentiment de connexion avec quelque chose de plus grand."
            style={styles.textarea}
            aria-label="Description de votre sentiment de connexion"
          />
        )}
        <button
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  button: {
    padding: "10px 20px",
    backgroundColor: "#555555", // Default inactive button color
    color: "#fff",
    border: "none",
    borderRadius: "10px",
    cursor: "pointer",
