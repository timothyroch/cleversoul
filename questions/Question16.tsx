...
const Question16: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>
          Ai-je ressenti de la paix intérieure à un moment donné aujourd’hui ?
        </h3>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez le moment où vous avez ressenti de la paix intérieure."
            style={styles.textarea}
            aria-label="Description du moment de paix intérieure"
          />
        )}
        <button
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  textarea: {
    ...
    resize: "none",
    fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", // Placeholder font matches text
  },
  nextButton: {
    padding: "12px 30px",
    backgroundColor: "#ffb347", // Active yellow color
