...
const Question4: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Ai-je ressenti de l’anxiété ou de la tristesse aujourd’hui ?{" "}
          <span style={styles.highlight}>Pourquoi ?</span>
        </h2>
        <p style={styles.subtitle}>
          Cliquez sur "Oui" ou "Non" pour répondre à la question.
        </p>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez vos sentiments d’anxiété ou de tristesse et leurs causes éventuelles."
            style={styles.textarea}
            aria-label="Description des sentiments d’anxiété ou de tristesse"
          />
        )}
        <button
