...
const Question27: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>
          Ai-je pris du temps pour moi-même et mes passions ?
        </h3>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez comment vous avez pris du temps pour vous-même et vos passions."
            style={styles.textarea}
            aria-label="Temps pour soi et passions"
          />
        )}
        <button
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  subtitle: {
    fontSize: "16px",
    color: "#d0d0d0", // Light gray for subtitle
    marginBottom: "30px",
  },
  question: {
    fontSize: "18px",
  ...
  buttonActive: {
    backgroundColor: "#ff5e62", // Active accent color
    boxShadow: "0 2px 4px rgba(255, 94, 98, 0.5)", // Enhanced shadow for active state
  },
  textarea: {
    width: "80%",
    maxWidth: "500px",
  ...
  nextButton: {
    ...
    fontWeight: "bold",
    transition: "background-color 0.3s, box-shadow 0.3s",
    boxShadow: "0 4px 6px rgba(255, 94, 98, 0.5)", // Subtle shadow
    width: "80%",
    maxWidth: "500px",
  },
  nextButtonDisabled: {
