...
const Question13: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>
          Ai-je pris un moment pour réfléchir ou méditer sur ma journée ?
        </h3>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez votre réflexion ou méditation sur votre journée."
            style={styles.textarea}
            aria-label="Description de votre réflexion ou méditation"
          />
        )}
        <button
