...
const Question7: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Ai-je eu des pensées négatives répétées aujourd’hui ?{" "}
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez si vous avez eu des pensées négatives répétées aujourd’hui."
            style={styles.textarea}
            aria-label="Description des pensées négatives répétées"
          />
        )}
        <button
