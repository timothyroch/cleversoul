...
const Question3: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Y a-t-il eu un moment où je me suis senti(e) submergé(e) ? Pourquoi ?
        </h2>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez un moment où vous vous êtes senti(e) submergé(e) et pourquoi."
            style={styles.textarea}
            aria-label="Description des moments submergés"
          />
        )}
        <button
