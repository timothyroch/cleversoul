...
const Question24: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h3 style={styles.question}>
          Ai-je avancé vers mes objectifs personnels aujourd’hui ?
        </h3>
        <textarea
          value={response}
          onChange={(e) => setResponse(e.target.value)}
          placeholder="Décrivez comment vous avez avancé (ou non) vers vos objectifs personnels aujourd’hui."
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  title: {
    fontSize: "24px",
    color: "#ff5e62", // Gradient color accent
    marginBottom: "20px",
    fontWeight: 600,
  },
  subtitle: {
  ...
  nextButton: {
    padding: "12px 30px",
    backgroundColor: "#ff5e62", // Accent color for button
    color: "#fff",
    border: "none",
    borderRadius: "10px",
    cursor: "pointer",
