...
const Question10: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Ai-je ressenti une connexion ou une satisfaction dans mes interactions sociales ?
        </h2>
        ...
        {showTextarea && (
          <>
            <textarea
              ...
              placeholder="Décrivez si vous avez ressenti une connexion ou une satisfaction dans vos interactions sociales."
              style={styles.textarea}
              aria-label="Description de la connexion ou satisfaction dans les interactions sociales"
            />
          </>
        )}
        <button
