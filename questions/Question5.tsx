...
const Question5: React.FC<QuestionProps> = ({ onNext }) => {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>
          Ai-je ressenti de la gratitude ou de la joie ? <span style={styles.highlight}>Pourquoi ?</span>
        </h2>
        <p style={styles.subtitle}>Quels en étaient les déclencheurs ?</p>
        ...
        {showTextarea && (
          <textarea
            ...
            placeholder="Décrivez vos sentiments de gratitude ou de joie et leurs déclencheurs."
            style={styles.textarea}
            aria-label="Description des sentiments de gratitude ou de joie"
          />
        )}
        <button
